...
class Email extends HTTP
{
	...
	public function main()
	{
		if ($_SERVER['REQUEST_METHOD'] === 'GET') {
			// Message in JSON
			parent::httpJsonResponse(200, 'This test resource exists!');
		} else if ($_SERVER['REQUEST_METHOD'] === 'POST') {

			$_POST = json_decode(file_get_contents("php://input"), true);
			parent::httpJsonResponse(202, htmlspecialchars($_POST["key"]));
		}
	}
	...
	private function sendEmail($_name, $_email, $_message)
	{
		...
		try {
			...
			$mail->send();
			parent::httpJsonResponse(202, 'Email Sent!');
		} catch (Exception $e) {
			parent::httpJsonResponse(406, 'Not Acceptable, Mail generated an ERROR and could not be sent: ' . $mail->ErrorInfo);
		}
	}
}
